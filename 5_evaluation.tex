...
\TODO{ISn't there one for does the best cipher switching strategy vary with different workloads/requirements?  Or did you decide that data is not very interesting?}
