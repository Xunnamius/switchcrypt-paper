...
discrete pareto optimal configurations attainable via prior work. On the other
hand, \figref{navigating-the-space} illustrates the flexibility of \SYSTEM{}
using the 0-forward switching strategy compared to prior work. additionally
shows the 40MB read performance of \SYSTEM{} 
