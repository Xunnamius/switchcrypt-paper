...
block ciphers while offering stronger security properties. However, 
optimizing for performance often conflicts with other key
concerns like energy usage and encryption strength. In this paper we present
SwitchCrypt, a software mechanism that navigates the tradeoff space made
