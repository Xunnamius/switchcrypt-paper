...
configuration providing the most useful security guarantees, and both may differ
from the configuration that uses the least amount of energy or allows the most
writable drive space}. Further, while the cipher choice can be configured
