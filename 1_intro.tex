...
default~\cite{android-M-mobile-motivation}. \TODO{I would end the previous sentence after the "four years after the release of..." and in place of the rest of that sentence add a new, one-sentence explanation of why they didn't enable it by default. Especially useful if you could pull a quote relating to the performance impact.}
...
performance~\cite{android-M-mobile-motivation-2}. \TODO{Hmmm.  This is great and the kind of thing I was looking for earlier.  Maybe move it up.  Also, I am hoping that the staggering is a real quote and not just scare quotes.  If it is real, maybe you could pull more context?}
...
et cetera. \TODO{I like "exotic security properties" as a turn of phrase, but you will need to add another sentence that clarifies what those properties are.}
...
offer versus each other. \TODO{One more sentence to give more intuition of what those properties might be.}
