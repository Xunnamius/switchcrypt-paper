\subsection{\sysA: Cipher Switching Models}\label{subsec:strategies}
...
spatial switching, as explained below and summarized in Table \tblref{switch1}.

\input{graphics/tbl-switch1}
...
Table \tblref{switch1} summarizes what happens during the switch. For new
...
During the migration, as summarized in Table \tblref{switch1}, all write
