\begin{tikzpicture}[baseline]
    ...
    \pgfmathsetmacro{\ymaxbreak}{4.1} % set the y value at which overflow is drawn
    ...
    \begin{axis}[
        ...
        xmin=C8, xmax=FB,
        xtick=data,
        symbolic x coords={C8,C8+FB,FB},
        enlarge x limits=0.2, % add some breathing room along the x axis's sides
        major x tick style=transparent,
        %
        ylabel={\footnotesize Latency (normalized to ChaCha8)},
        ylabel near ticks,
        ylabel shift={-3mm},
        ymajorgrids=true,
        ymin=0, ymax=\ymax,
        ...
        table[x=conf, y=latr, col sep=space] {charts/usecase-vsr.dat};
        \addplot[fill=purpleDark, every node near coord/.append style={color=purpleDark}]
        table[x=conf, y=latw, col sep=space] {charts/usecase-vsr.dat};
    \end{axis}%
\end{tikzpicture}%
