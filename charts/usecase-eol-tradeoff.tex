\begin{tikzpicture}[baseline]
    ...
    \begin{groupplot}[
        ...
        \nextgroupplot[title={Sequential Reads}]
            ...
            \coordinate (c1) at (2.075, 0.8);
            \coordinate (c2) at (0.5, 0.08);
            \draw [dotted] (1.9, 0) -- (1.9, 1.1) node [left of=c1] {\tiny (security floor)};
            \draw [dotted] (0, 0.3) -- (4, 0.3) node [above of=c2] {\tiny (latency ceiling)};
        \nextgroupplot[legend to name={throwaway9}, title={Random Reads}]
            ...
            \coordinate (c3) at (2.075, 0.8);
            \coordinate (c4) at (0.5, 0.08);
            \draw [dotted] (1.9, 0) -- (1.9, 1.1) node [left of=c3] {\tiny (security floor)};
            \draw [dotted] (0, 0.3) -- (4, 0.3) node [above of=c4] {\tiny (latency ceiling)};
        \nextgroupplot[legend to name={throwaway10}, title={Sequential Writes}]
            ...
            \coordinate (c5) at (2.075, 0.8);
            \coordinate (c6) at (0.5, 0.08);
            \draw [dotted] (1.9, 0) -- (1.9, 1.1) node [left of=c5] {\tiny (security floor)};
            \draw [dotted] (0, 0.3) -- (4, 0.3) node [above of=c6] {\tiny (latency ceiling)};
        \nextgroupplot[legend to name={throwaway11}, title={Random Writes}]
            ...
            \coordinate (c7) at (2.075, 0.8);
            \coordinate (c8) at (0.5, 0.08);
            \draw [dotted] (1.9, 0) -- (1.9, 1.1) node [left of=c7] {\tiny (security floor)};
            \draw [dotted] (0, 0.3) -- (4, 0.3) node [above of=c8] {\tiny (latency ceiling)};
    \end{groupplot}%
\end{tikzpicture}%
