\begin{tikzpicture}[baseline]
    ...
    \begin{axis}[
        ...
        %
        ylabel={\footnotesize Latency (seconds)},
        ylabel near ticks,
        ylabel shift={-1mm},
        ymajorgrids=true,
        ymin=0, ymax=\ymax,
        ...
        table[x=conf, y=latr-4k, col sep=space] {charts/usecase-vsr-bar.dat};
        \addplot[fill=purpleDark, every node near coord/.append style={color=purpleDark}]
        table[x=conf, y=latw-4k, col sep=space] {charts/usecase-vsr-bar.dat};
        \addplot[fill=orangeDark, postaction={pattern=north east lines}, every node near coord/.append style={color=orangeDark}]
        table[x=conf, y=latr-5m, col sep=space] {charts/usecase-vsr-bar.dat};
        \addplot[fill=purpleDark, postaction={pattern=north east lines}, every node near coord/.append style={color=purpleDark}]
        table[x=conf, y=latw-5m, col sep=space] {charts/usecase-vsr-bar.dat};
    \end{axis}%
\end{tikzpicture}%
