\begin{tikzpicture}[baseline]
    \begin{groupplot}[
        ...
        legend entries={%
            {\scriptsize Mirrored Scores (Without SwitchBox)},
            {\scriptsize Desired Minimum Score (Exclusive)},
            {\scriptsize Actual Minimum Score (SwitchBox)}
        },
        legend style={
            draw=none,
            legend columns=2,
        ...
        \nextgroupplot[
            ...
            \coordinate (c3) at (0.21, 2.5);
            \coordinate (c4) at (0.825, 2.5);
