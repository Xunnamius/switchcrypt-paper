...
using one cipher or the other. When the system determines that a nugget should
transition from one cipher to the other.
...
In the purposes of our implementation, we limit cipher switching to pairs of
ciphers. However, there is no reason nuggets encrypted with three, four, or more
ciphers could not exist in harmony on the same backing store.
