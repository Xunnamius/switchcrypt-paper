...
Delete? Different chart referenced here instead?}
...
% \subsection{Pluggable Stream Cipher API} Should we talk about Pluggable Stream
% Cipher API in its own section, or just as a challenge?
...
\TODO{Pluggable Stream Cipher API}
