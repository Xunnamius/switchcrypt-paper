...
We revisit the motivating example from \secref{motivation}, where we're using
Freestyle to ensure secure backups. Initially, I/O requests come down from the
LFS and are received by the cryptographic driver, which divides the request
