...
\hank{The part that is missing here is some kind of motivation for
  ...
  do this, not necessarily as a reason that SwitchCrypt should keep
  it.
  \\
  \\
  So, I want something of the form: The key insight behind SwitchCrypt
...
context of SwitchCrypt FDE.  However, different ciphers have a wide
...
Unlike prior work, SwitchCrypt must be able to encrypt and decrypt
