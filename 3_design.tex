...
guarantees of the available ciphers used to encrypt nuggets. \hank{This last
sentence needs to be rephrased because our motivational example describes a
practical attack on existing ciphers that do not use output randomization. }
...
our enterprise backup service every so often. \hank{Probably need to say that we
start with Freestyle to meet all the demands.  I have to be honest and say that
even I forgot about that until I reread it here and I am sure that reviewers
will be paying much less attention than me.}
