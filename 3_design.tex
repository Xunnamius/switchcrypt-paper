...
\TODO{Stress that ciphers are scored given the usefulness of their cryptographic
properties to SwitchBox FDE. We base this on three factors.}
...
se properties to SwitchBox FDE. (see: \tblref{security-quant}).\\
\\
