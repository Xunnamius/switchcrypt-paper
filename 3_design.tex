...
The SwitchCrypt design allows many differently-encrypted storage units to
...
where different regions of the backing store can store differently-encrypted
...
re-encrypting an entire region's nuggets.
