...
finish before the devices dies. \TODO{Add that when we get back to a charger,
SwitchCrypt can easily recrypt the parts in ChaCha8 back to Freestyle Balanced?}
...
\TODO{If you mention this prior work here, you need to say more about what the
difference is. Like prior work used a similar idea for streaming data, but not
for data at rest?  I don't know how they handled their metadata now that I think
about it.}
...
sensitive information exists within several much larger files. \TODO{The "file
or files" language detracts from this section a bit.  It would be stronger if
you just stuck with one.  Can you actually support different regions within a
file?  If so, that is much stronger in my mind.  Even saying you simulate it
...
\TODO{Consider adding some kind of lessons learned at the end if you can think
of some "pithy" lessons here.}
