\begin{tikzpicture}[baseline]
    ...
    \pgfmathsetmacro{\ymax}{25} % set the maximum y value
    \pgfmathsetmacro{\ymaxbreak}{25.1} % set the y value at which overflow is drawn
    ...
    \begin{axis}[
        ...
        xmin=FB, xmax=C8+FB,
        xtick=data,
        symbolic x coords={FB,C8+FB},
        xticklabels={FB only,Forward (C8+FB)},
        ...
        legend entries={
            {\scriptsize 40M/reads},
            {\scriptsize 40M/writes}
        },
        legend style={
            draw=none,
            legend columns=4,
        ...
        table[x=conf, y=energy-r, col sep=space] {data/usecase-battery.dat};
        \addplot[fill=blueDark, postaction={pattern=north east lines}, every node near coord/.append style={color=blueDark}]
        table[x=conf, y=energy-w, col sep=space] {data/usecase-battery.dat};
    \end{axis}%
\end{tikzpicture}%
% \begin{tikzpicture}[baseline]
...
%                 x=time,
%                 y=energy,
%                 discard if symbol not={cipher}{c8+fb},
%                 discard if symbol not={iop}{w},
%                 col sep=space,
%                 mark=none
%             ] {data/usecase-battery.dat};
...
%         \nextgroupplot[legend to name={throwaway7}, ylabel={Trade Score}, ymin=0, ymax=3, ytick={ 0, 3 }, yticklabels={ 0, 1 }, ylabel shift={-1.5mm}]
%             \addplot [thick] table [
%                 x=time,
%                 y=score,
%                 discard if symbol not={cipher}{fb},
