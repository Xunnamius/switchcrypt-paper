...
\begin{figure}[ht]
  ...
  {\input{data/tradeoff-with-ratios}} \caption{Median sequential and random
...
\begin{figure}[ht]
  ...
  \centering
  {\input{data/mirrored-selective-baseline}} \caption{Median sequential and
