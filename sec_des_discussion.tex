...
\mysub{Trade score.} While we do not gain anything useful by comparing across
dimensions; \ie it is meaningless to compare one crypt's round score to another
crypt's randomization score.
