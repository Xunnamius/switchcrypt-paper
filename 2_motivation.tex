...
configuration that trades the security properties of active nuggets (\ie{to
where the downloaded movie's bytes and filesystem metadata updates are being
written}) so that we stay within our curtailed energy budget and successfully
