...
\TODO{I like the how, when, where framework.  Should we add why? to the first challenge (of scoring) and say that we can now define a tradeoff space used to answer "why?" we would prefer one cipher over another? }
