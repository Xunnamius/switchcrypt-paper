...
Google's investment in Adiantum~\cite{Adiantum}. \hank{probably need a
  parenthetical statement or similar to remind people what Adiantum
  is, since to this point it was only mentioned once in the intro, and
  even then it was separated from the main sentence by M-dashes.}
