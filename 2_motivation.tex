...
\TODO{Can you say anything about why this insight is enabled by stream ciphers or StrongBox and would be worse (harder) if you only had old AES systems to work with?  Even if it is something like AES based approaches just assume there is no metadata, etc.}
...
To address this challenge, we propose a method for quantitative cipher comparison in the
