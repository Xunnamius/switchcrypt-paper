...
\TODO{I like the how, when, where framework.  Should we add why? to the first challenge (of scoring) and say that we can now define a tradeoff space used to answer "why?" we would prefer one cipher over another? If you do that, then you should add to the paragraph that introduces these challenges that they correspond to the why, how, when, and where of cipher-switching and maybe give people a preview of what that means.}
