...
\begin{figure}[ht]
 \centering
  \includegraphics[width=0.8\linewidth]{drawn/1.png}
   \caption{\TODO{Caption goes here}\TODO{Include parateo curve in this version??}}\label{fig:40mb-read-with-forward}
\end{figure}
...
points along parateo curve and differentiate between static points and dynamic
points}.
