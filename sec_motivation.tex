...
\hank{I got really confused by the previous sentence.  I think that just needs to be rewritten because I am not clear what lesson we are supposed to be learning from wireless.  Is it that some data is transmitted with lower expected loss than others?  If so, I think that can be worded much more clearly.}
