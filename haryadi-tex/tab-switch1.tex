...
\end{verbatim}
\end{center}
\mycaption{tab-switch}{Reciphering/switching modes}{The table explains for every mode
  what happens on I/Os when the switch happens from cipher A to cipher B.
  ``Read'' means read of existing data during the switch.  ``Write'' means
  new.  }
\end{table}
