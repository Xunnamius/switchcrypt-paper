...
..\hsg{anything about data structures, such as the extra space of teh
  nugget?  Let's put more technical matters here, so reviewers can
  appreciate why we have to crude partition the drive like this.}  Second,
