...
\newcommand{\SystemURI}{(will be included in camera-ready submission)}%https://git.xunn.io/research/switchbox}
...
%Encryption}
\title{SwitchBox: Navigating Tradeoffs in Stream Cipher Based FDE}
