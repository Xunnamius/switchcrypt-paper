...
\newcommand{\SystemURI}{(will be included in final paper)}%https://git.xunn.io/research/switchbox}
...
%Encryption}
\title[SwitchBox: Tradeoffs Leveraging LFS Behavior in Stream Cipher Based
FDE]{SwitchBox: Tradeoffs Leveraging LFS Behavior in Stream Cipher Based Full
Drive Encryption}
