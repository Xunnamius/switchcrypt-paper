...
\newcommand{\SystemURI}{https://github.com/ananonrepo2/SwitchCrypt}%https://git.xunn.io/research/SwitchCrypt}
...
\acmConference[EUROSYS]{The European Conference on Computer Systems}{2020}{X}
\acmBooktitle{}
\acmPrice{}
...
%% Title information
%\title[short]{long}
\title{SwitchCrypt: Navigating Tradeoffs in Steam Cipher Based Full Drive Encryption}
