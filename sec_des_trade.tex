...
\Cref{tbl:trade} shows the relative round score for twelve crypts
...
\mysub{Ciphertext Randomization (Randomization).} A cipher employing
...
\Cref{tbl:trade} shows the ciphertext randomization score for twelve
