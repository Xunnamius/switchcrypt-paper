...
\begin{figure}[t]
    \centerline{
        % \hmina
        % {\input{data/eval-forward}}
        % \hminb
        \includegraphics[height=\fgh]{empty.eps}
    }

    \mycaption{fig:eval-forward}{Forward I/O performance}{Median sequential and
    random I/O compared to baseline. Each cluster of 3 dots between
