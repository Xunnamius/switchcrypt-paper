% This section is not included in the paper rendering process and has been
% punted into the dissertation instead.
...
the drive when spatially switching. We simulate this with IPC. \TODO{You should
spell out exactly what that intent parameter means and maybe change its name so
its use is clearer.} \PUNT{This is especially important when considering the
