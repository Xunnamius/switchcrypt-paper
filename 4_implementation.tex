...
\PUNT{This is especially important when considering the selective
...
tracking, detecting, and handling overwrites when nuggets are using it. \TODO{Add one more thing.  If read quickly, it sounds like Freestyle should be very fast, but it gets all this because the encryption itself is much slower, right?  If so, it is worth saying that removing this overhead is just a minor reduction in the cost of using this cipher.  You can word it better than me.}
