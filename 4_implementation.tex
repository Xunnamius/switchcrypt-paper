...
15,568 lines of C code. \TODO{Can you put it on an anonymous github site?  Or just mention that it will be released after the anonymous review period?}
...
overhead (\ie{transaction journal updates, re-encrypting nuggets on overwrites})
...
specific areas of the backing store when spatially switching. \TODO{Did you implement this for one case study?  If so, you should say so.  Also, don't you just need the write to change?  Read should read whatever, right?} \PUNT{This is
